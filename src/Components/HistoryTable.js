...
const EnhancedTableToolbar = (props) => {
    ...
    const [openTnxModal, setOpenTnxModal] = React.useState(false);
    return (
        <Toolbar
        ...
        >
            ...
            <Button style={{ marginRight: 10 }} onClick={() => setOpenTnxModal(true)}>
                Transaction
            </Button>
            <AddTnxModal open={openTnxModal} setOpen={setOpenTnxModal} />
        </Toolbar>
    );
};
